...
public class TridentEnchantment {
     ...
     */
    public TridentEnchantment(CEnchantments enchantment, double damageAmplifier, boolean isLevelAddedToAmplifier) {
     ...
     */
    public TridentEnchantment(CEnchantments enchantment, List<PotionEffects> potionEffects, boolean isLevelAddedToAmplifier) {
        this.enchantment = enchantment;
